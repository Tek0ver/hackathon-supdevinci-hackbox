            ...
            <div class="col-md-3">
                <form method="POST" action="{{ route('search') }}">
                    ...
                    <div class="search-bar-container">
                        <input type="text" name="ip" placeholder="Rechercher par IP..." value="{{ $ip }}" class="search-bar">
                                ...
                                @foreach ($machine->tests as $test)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade modal-lg" id="modalLabel-{{ $test->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                    ...
                                                                    @foreach($arrayData["result"] as $dataVal)
                                                                        @if (array_key_exists("cve", $dataVal))
                                                                            <tr>
                                                                                ...
                                                                                <?php $cvss = $dataVal["cvss"]; 
                                                                                        $cvss = intval($cvss); 
                                                                                        if ($cvss > 0 and $cvss < 6) { ?>
                                                                                            <td style="background-color: yellow;">
                                                                                                {{$dataVal["cvss"]}}
                                                                                            </td>
                                                                                <?php } ?>
                                                                                <?php
                                                                                        if ($cvss >= 6 and $cvss < 8) { ?>
